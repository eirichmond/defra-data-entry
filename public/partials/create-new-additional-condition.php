...
<?php } else { ?>
	...
	<form class="w-full" action="/data-entry/form-process/" method="post">
		...
		<div class="md:flex md:items-center mb-6">
			<div class="md:w-1/4">
				<label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="additional-condition">Additional Condition</label>
			</div>
			<div class="md:w-3/4">
				<input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="text" name="additional-condition" id="additional-condition" value="" required>
			</div>
		</div>
