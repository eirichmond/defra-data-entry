...
<!-- to insert duplication functionality -->
	...
	<fieldset>
		...
		<div class="mb-3">
			<textarea class="form-control" id="appliance_name" rows="3" name="appliance_name"></textarea>
		</div>
	</fieldset>
		...
		<div class="mb-3">
			...
			<div class="row">
				...
				<div class="col-8">
					...
					<label for="appliance_additional_details_linked_applications" class="form-label">Linked Application</label>
