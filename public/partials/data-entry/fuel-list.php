<tr>
    ...
    <td style="width:30%">
        <strong>England:</strong> <?php echo esc_html($class->si_status(get_post_meta(get_the_ID(), 'authorised_country_and_statutory_instrument_england_status', true))); ?><br>
        <strong>Wales:</strong> <?php echo esc_html($class->si_status(get_post_meta(get_the_ID(), 'authorised_country_and_statutory_instrument_wales_status', true))); ?><br>
        <strong>Scotland:</strong> <?php echo esc_html($class->si_status(get_post_meta(get_the_ID(), 'authorised_country_and_statutory_instrument_scotland_status', true))); ?><br>
        <strong>N. Ireland:</strong> <?php echo esc_html($class->si_status(get_post_meta(get_the_ID(), 'authorised_country_and_statutory_instrument_n_ireland_status', true))); ?>
    </td>
    <td style="width:30%">
    ...
    <form action="/data-entry/form-process/" method="post">
        <ul class="list-unstyled icon-component">
            ...
            <li>
                <a href="<?php echo esc_html( '/fuel-audit-log/?appliance='.get_the_ID() ); ?>"><i class="gg-folder"></i></a>
            </li>
            <li>
